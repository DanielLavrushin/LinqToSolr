    ...
    static class JsonWriter
    {
        ...
        static void AppendValue(StringBuilder stringBuilder, object item)
        {
            ...
            else
            {
                ...
                {
                    if (!propertyInfo[i].CanRead || propertyInfo[i].IsDefined(typeof(LinqToSolrFieldIgnoreAttribute), true))
                        continue;
        ...
        static string GetMemberName(MemberInfo member)
        {
            ...
            {
                var dataMemberAttribute = member.GetCustomAttribute<LinqToSolrFieldAttribute>();
